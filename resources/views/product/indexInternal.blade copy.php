        ...
        @foreach($products as $product)
          <form >
            <td><button id="addToCart" class="rounded"><a href="{{ url('cart.addToCart/'.$product['id']) }}">Add to Order</button> </td>
              <!-- <td class="text-center" ><input class="text-center" id="quantity" {{ $product['quantity'] }}></td> -->
          </form>
          <td><button id="addToCart" class="rounded"><a href="{{ url('cart.addToCart/'.$product['id']) }}">Add to Order</button> </td>
          <td class="text-center" ><input class="text-center qty-input" id="quantity" {{ $product['quantity'] }}><button class="increment-btn">+</button></td>
